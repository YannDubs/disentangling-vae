...
class Evaluator:
    ...
    def compute_metrics(self, dataloader, dataset=None):
        ...
        if dataset in ['dsprites']: # Most metrics are only applicable for datasets with ground truth variation factors
            ...
            accuracies = self._disentanglement_metric(method_names, sample_size=300, lat_sizes=lat_sizes, imgs=lat_imgs, n_epochs=20000, dataset_size=7500, hidden_dim=512, use_non_linear=False)
