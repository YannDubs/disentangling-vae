...
class Evaluator:
    ...
    def compute_metrics(self, dataloader):
        ...
        accuracies = self._disentanglement_metric(method_names, sample_size=300, lat_sizes=lat_sizes, lat_imgs=lat_imgs, n_epochs=150, dataset_size=1500, hidden_dim=512, use_non_linear=False)
