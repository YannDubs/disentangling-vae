...
class DecoderHigginsdsprites(nn.Module):
    def __init__(self, img_size,
        ...
        self.lin3 = nn.Linear(1200, 1200)
        self.lin4 = nn.Linear(1200, 4096)
    ...
    def forward(self, z):
        ...
        x = torch.sigmoid(self.lin4(x)).reshape((batch_size, 1, 64, 64)).to(self.lin1.device) # Sigmoid because the distribution over pixels is supposed to be Bernoulli
        return x
...
class DecoderHigginsconv(nn.Module):
    def __init__(self, img_size,
        ...
        self.reshape = (hid_channels2, kernel_size, kernel_size)
        ...
        self.convT_64 = nn.ConvTranspose2d(hid_channels2, hid_channels2, kernel_size, **cnn_kwargs)

        self.convT1 = nn.ConvTranspose2d(hid_channels2, hid_channels2, kernel_size, **cnn_kwargs)
        self.convT2 = nn.ConvTranspose2d(hid_channels2, hid_channels, kernel_size, **cnn_kwargs)
